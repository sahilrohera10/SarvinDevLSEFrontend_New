...
const CampaignDescription = ({ campaignDescription, setCampaignDescription, handleNext, handlePrevious }) => {
        ...
        <div className="w-full sm:h-[70vh] flex flex-col justify-center items-center px-6 py-12 lg:px-8">
          <div className="w-2/3 h-full px-10 flex flex-col items-center justify-between">
            <div className="w-2/3">
              ...
              <div className="mt-10">
                <h3 className="text-start font-normal font-sans text-gray-900">
