    ...
    return (
      <div className="max-w-md bg-black relative group border shadow-lg rounded-lg mb-10">
        ...
        <div className="p-3.5 bg-white">
          ...
          <div className="text-gray-400 text-md -mt-3 mr-2 w-full">
            <button
              class="flex w-full justify-center rounded-md bg-gray-500 px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
