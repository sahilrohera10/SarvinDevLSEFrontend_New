...
const BUTTONSTATEMENT = [
  "Applied..Waiting for Author Acceptance",
  "Insert link of Posted Deals here",
  "Target is not yet completed",
          ...
          <div class="mx-4 mt-6 font-600">
            ...
            <ol class="flex items-center w-full mt-2">
              <li
                class={
                  crackedSteps >= 1
                    ...
                    : "flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-blue-800"
                }
              >
                <span
                  class={
                    crackedSteps >= 1
                      ...
                      : "flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-800 shrink-0"
                  }
                >
                  {crackedSteps >= 1 ? (
                    <svg
              ...
              <li
                class={
                  crackedSteps >= 2
                    ? "flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-100 after:border-4 after:inline-block dark:after:border-gray-700"
